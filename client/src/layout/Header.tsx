            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 shadow">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        ...
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Чита</span>
                    </Link>
                    <div className="flex items-center lg:order-2">
                        {/* TODO write mail icon */}
                        <Link to="#" className="bg-red-500 w-8 h-8 flex items-center justify-center">
